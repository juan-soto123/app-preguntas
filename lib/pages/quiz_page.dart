...
import 'package:test1app/classes/question.dart';
import 'package:test1app/classes/quiz.dart';
import 'package:test1app/pages/results_page.dart';
...
class _QuizPageState extends State<QuizPage> {
  ...
  int questionIndex = 0;
  int progressIndex = 0;
  Quiz quiz = Quiz(name: 'Quiz de paises', questions: []);
  ...
  Widget _buildResultDialog(BuildContext context) {
    return AlertDialog(
      title:
          Text('Resultados', style: Theme.of(context).textTheme.displayLarge),
